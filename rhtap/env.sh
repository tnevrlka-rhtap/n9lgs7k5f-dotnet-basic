...
export IMAGE_URL=${IMAGE_URL-quay.io/tnevrlka-rhtap/rhtap-qe-dotnet-basic:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/tnevrlka-rhtap/n9lgs7k5f-dotnet-basic-gitops
